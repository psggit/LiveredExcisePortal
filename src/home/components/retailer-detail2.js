          ...
          ? <Fragment>
            <div className="order-detail__header">
              <div>
                ...
                <span style={{ fontSize: '18px', color: '#687189' }}>Retailer Name: <b>{`${this.props.location.state.name}`}</b></span>
              </div>
                    ...
                    : (
                      <div style={{ marginTop: '10px' }}>
                        <Toggle isToggled={this.props.location.state.status === 'Authorized'} />
                        {
                          ...
                          ? <span style={{ color: '#6D788F', marginLeft: '20px' }}>Retailer Authorized for Delivery Service</span>
                          : <span style={{ color: '#6D788F', marginLeft: '20px' }}>Retailer Deauthorized for Delivery Service</span>
                        }
                      </div>
                    )
                  }
            ...
            <div style={false ? { display: 'block' } : {}} className="order-detail__body">
              {
                true
                ? (
                  <React.Fragment>
