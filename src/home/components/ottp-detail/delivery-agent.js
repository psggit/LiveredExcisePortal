...
const OttpDetailDeliveryAgent = ({ name, sourceRetailer }) => (
    ...
    <div className="item">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap' }}>
        <div style={{ width: '50%', marginBottom: '30px' }}>
          ...
          <p className="value">Arijit</p>
        </div>

        <div style={{ width: '50%' }}>
          <p className="label">Vehicle License No.</p>
          <p className="value">WB 134</p>
        </div>
        ...
        <div style={{ width: '50%' }}>
          ...
          <p className="value">WB01 2012122341193</p>
        </div>

        <div style={{ width: '50%' }}>
          <p className="label">Phone No.</p>
          <p className="value">+91 98676 62333</p>
        </div>
